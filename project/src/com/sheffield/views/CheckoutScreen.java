...
public class CheckoutScreen extends JFrame {
     ...
     */
    public CheckoutScreen(Connection connection) {
        super();
    ...
    private void goToOrderLine(Connection connection, java.awt.event.ActionEvent evt) {
        dispose();
